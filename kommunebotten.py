...
def grovfilter(tekst):
    ...
    kjedelige_ord = ["avslag søknad", "tjenestebevis", "vikariat", "svar på søknad", "avslag, ikke videre", "parkering", "skjenkebevilling", "ferdigattest", "igangsetting", "sanitær", "feilsortert avfall", "ekstratømming", "gebyr", "startlån", "tilleggslån", "motorferdsel", "vigsel", "barnehagemappe", "personalmappe", "elevpermisjon", "elevmappe", "ledsagerbevis", "sykefraværsoppfølging"]
