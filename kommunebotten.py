...
def grovfilter(tekst):
    ...
    kjedelige_ord = ["parkering", "skjenkebevilling", "ferdigattest", "igangsetting", "sanitær", "feilsortert avfall", "ekstratømming", "gebyr", "startlån", "tilleggslån", "motorferdsel", "vigsel", "elevpermisjon", "elevmappe", "ledsagerbevis"]
